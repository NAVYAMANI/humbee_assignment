...
return (
    ...
    <Row>
            ...
            arr.map((slot, index)=>{
                return(
                  <Col style={{marginTop:"10px",marginLeft:"20px"}} md={1} key={index}>
                    ...
                    <div style={{background:"orange",color:"white"}}>book here</div>
                    </OverlayTrigger>
        ...
        <Button variant="primary" style={{marginTop:"10px"}} onClick={addMore}>Add 10 Slots</Button>
